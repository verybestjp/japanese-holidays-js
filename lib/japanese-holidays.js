...
(function() {
  "use strict";
  var definition, furikaeHoliday, getHolidaysOf, getJDate, getJDay, getJFullYear, getJHours, getJMinutes, getJMonth, happyMonday, holidays, isHoliday, j2u, jDate, kokuminHoliday, ref, shiftDate, shubun, shubunWithTime, shunbun, shunbunWithTime, simpleHoliday, target, u2j, uDate;
  ...
  kokuminHoliday = function(holiday) {
    ...
    if (isHoliday(kokumin, false) || getJDay(kokumin) === sunday || getJDay(kokumin) === monday) {
      return null;
    }
    return kokumin;
  };
